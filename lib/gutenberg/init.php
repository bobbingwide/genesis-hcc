...
add_action( 'wp_enqueue_scripts', 'genesis_hcc_enqueue_gutenberg_frontend_styles' );
/**
 * Enqueues Gutenberg front-end styles.
 *
 * @since 2.7.0
 */
function genesis_hcc_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'genesis_hcc_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function genesis_hcc_block_editor_styles() {
...
add_filter( 'body_class', 'genesis_hcc_blocks_body_classes' );
/**
 ...
 */
function genesis_hcc_blocks_body_classes( $classes ) {
...
add_action( 'after_setup_theme', 'genesis_hcc_content_width', 0 );
/**
 * Set content width to match the “wide” Gutenberg block width.
 */
function genesis_hcc_content_width() {

    // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- See https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/924
    $GLOBALS['content_width'] = apply_filters( 'genesis_hcc_content_width', 1062 );
