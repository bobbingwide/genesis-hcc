...
add_action( 'customize_register', 'genesis_hcc_customizer_register' );
/**
 ...
 */
function genesis_hcc_customizer_register( $wp_customize ) {

    $wp_customize->add_setting(
        'genesis_hcc_link_color',
        array(
            'default'           => genesis_hcc_customizer_get_default_link_color(),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            array(
                ...
                'section'     => 'colors',
                'settings'    => 'genesis_hcc_link_color',
            )
        )
    );

    $wp_customize->add_setting(
        'genesis_hcc_accent_color',
        array(
            'default'           => genesis_hcc_customizer_get_default_accent_color(),
            'sanitize_callback' => 'sanitize_hex_color',
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            array(
                ...
                'section'     => 'colors',
                'settings'    => 'genesis_hcc_accent_color',
            )
        )
    );

    $wp_customize->add_setting(
        'genesis_hcc_logo_width',
        array(
            'default'           => 350,
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'settings'    => 'genesis_hcc_logo_width',
            'type'        => 'number',
            'input_attrs' => array(
                'min' => 100,
            ),
